...
async def health_check(
    ...
    return HealthResponse(
        ...
        chromadb_connected=chroma.is_connected,
        chromadb_collections=chroma.collection_count,
        chromadb_total_documents=chroma.document_count,
